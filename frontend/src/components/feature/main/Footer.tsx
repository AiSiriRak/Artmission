      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-12 md:gap-8">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-gray-300 text-sm leading-relaxed max-w-sm">
            Artmission: The art platform that integrates a creative community by
            giving indie artists a space to sell their work, while making it
            easy and accessible for buyers to discover them.
          </p>
        </div>
            ...
            <li className="flex items-center gap-3">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="1.5"
                  d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3.81l.33-4H14V7a1 1 0 011-1h3V2z"
                ></path>
              </svg>
